...
namespace Assets.SimpleAndroidNotifications
{
    public static class NotificationManager
    {
        ...
        internal static void Send(TimeSpan timeSpan, object delay, string v1, object title, string v2, object message, Color color, object smallIconColor, NotificationIcon notificationIcon, object smallIcon)
        {
